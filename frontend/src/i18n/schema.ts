...
export interface MobileStrings {
  ...
  // ── Voice input (speech-to-text mic buttons) ───────────────────
  voiceSpeakBtn: string;
  voiceListening: string;
  voiceCancelBtn: string;
  voiceSpeakA11y: string;
  voiceStopA11y: string;
  voiceCancelA11y: string;
  voiceTranscribingA11y: string;
  voiceMicPermission: string;
  voiceNothingHeard: string;
  voiceTranscribeError: string;
  voiceRecordError: string;
