      ...
      >
        ...
        <Card style={styles.stepCard}>
          ...
          <View style={styles.voiceActions}>
            {/* Voice input (speech-to-text) — transcript lands in the description field. */}
            <VoiceInputButton
              expanded
              value={voiceNote}
              onChangeText={setVoiceNote}
              language={lang}
              style={styles.voiceActionFlex}
            />
            {/* Voice guidance (text-to-speech) — reads the description back. */}
            <Pressable
              onPress={handleSpeakDescription}
              disabled={!voiceNote.trim() || isSpeakingDescription}
              style={[styles.voiceAction, styles.voiceActionFlex, (!voiceNote.trim() || isSpeakingDescription) && styles.voiceActionDisabled]}
