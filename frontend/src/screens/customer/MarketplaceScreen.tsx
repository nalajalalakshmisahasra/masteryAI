...
export const MarketplaceScreen: React.FC = () => {
  ...
  const [searchVoiceError, setSearchVoiceError] = useState<string | null>(null);
    ...
    <>
      ...
      <Card elevated style={styles.searchCard}>
        <View style={styles.searchRow}>
          ...
          />
          {/* Voice input: speak the search instead of typing it. */}
          <VoiceInputButton
            value={searchQuery}
            onChangeText={setSearchQuery}
            onErrorChange={setSearchVoiceError}
          />
          <Button
            title={t('searchBtn')}
        ...
        {searchVoiceError ? (
          <Text style={[TYPOGRAPHY.footnote, styles.voiceSearchError]}>{searchVoiceError}</Text>
        ) : null}
